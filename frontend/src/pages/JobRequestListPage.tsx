...
export default function JobRequestListPage() {
  ...
  async function handleCancel(id: number) {
    ...
    try {
      ...
      setJobRequests((prev) =>
        prev.map((j) => (j.id === id ? res.job_request : j))
      );
    } catch (err: any) {
    ...
    <>
      ...
      <main className="container py-5">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <h1 className="h3 fw-bold mb-0">Job Requests</h1>
          {isEndUser && (
            <Link to="/job-requests/new" className="btn btn-primary">
              + New Job Request
            </Link>
          )}
        </div>
              ...
              <div key={job.id} className="col-12">
                <div className="card shadow-sm">
                  <div className="card-body">
                    ...
                    {job.description && (
                      <p className="card-text text-muted mt-2 mb-2">
                        {job.description}
                      </p>
                    )}
                    ...
                    <div className="mt-3 d-flex gap-2 flex-wrap">
                      ...
                      {isEndUser && job.cleaner_id !== null && ['pending', 'confirmed'].includes(job.status) && (
                        <button
